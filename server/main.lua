---------------------------------------------------------------------------------------
-- Bu tabloyu kendi tablolarınıza göre düzenleyin
-- Çekilecek verileri unutmayın. Ekstra da ekleyebilirsiniz. 'users, owned_vehicles, user_accounts'
---------------------------------------------------------------------------------------
...
AddEventHandler('kashactersS:CharacterChosen', function(charid, ischar)
    ...
    if ischar == "true" then
        ...
        spawn = { x = 195.55, y = -933.36, z = 29.90 } -- VARSAYILAN DOĞUM NOKTASI
    end
